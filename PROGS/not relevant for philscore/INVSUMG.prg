 SET CENTURY ON
 SELECT gender, type, odsphere, odcylinder, odadd, COUNT(*) AS quantity FROM glsku GROUP BY 1, 2, 3, 4, 5 INTO CURSOR invsum
 ...
 BROWSE TITLE 'Eyeglass inventory summary by gender, type, and OD sphere, cylinder and add -- Ctrl+P to print, Ctrl+F to file '+fn
 RELEASE WINDOW brow
 ON KEY
 SET CENTURY OFF
 RETURN
